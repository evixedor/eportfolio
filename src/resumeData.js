	...
	portfolio: [
		{
			...
			description:
				"An app developed using REACT. The app's components have been developed using functional component.",
		...
		},
		{
			...
			description:
				"An app developed using REACT. The app's components have been developed using class component.",
